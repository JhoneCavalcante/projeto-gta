...
Objetivo 1 - Quando o usuário clicar no botão de seleção de plataformas deve abrir as
uma caixa com os botões de seleção de plataforma.
...
clicar em cima do botão, o conteúdo deve ser escondido.
    ...
    Passo 1 - Verificar se o botão já está aberto pelo usuário, se sim, devemos remover a classe ativo para que ele esconda o conteúdo novamente.
